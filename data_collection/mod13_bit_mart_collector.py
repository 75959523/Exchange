...
logger = setup_logger("bit_mart_collector", os.path.join(project_root, 'log', 'app.log'))


def bit_mart(temp_table_name):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info(f"-------------------------------------------------- bit_mart executed in {elapsed_time} seconds.")
    except Exception as e:
        logger.error("Failed to get tickers from bit_mart", e)
