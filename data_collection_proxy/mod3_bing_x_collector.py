...
from data_processing_proxy.mod3_bing_x_processor import filter_symbols, insert_to_db
from proxy_handler.proxy_loader import ProxyRotator

project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
logger = setup_logger("bing_x_collector", os.path.join(project_root, 'log', 'app.log'))

rotator = ProxyRotator(os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'proxy_handler', 'mod3_bing_x.txt'))
