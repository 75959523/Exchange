...
from data_stablecoin.stable_coin_processing import coinex_stable_coin
from web_interaction.exclusion import get_filtered_symbols_for_exchange

project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
logger = setup_logger("coinex_processor", os.path.join(project_root, 'log', 'app.log'))
...
def filter_symbols(data):
    ...
    coinex_stable_coin(found_records)
